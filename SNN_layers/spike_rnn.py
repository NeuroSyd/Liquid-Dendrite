...
class spike_rnn_test_denri_wotanh_R(nn.Module):
    ...
    def forward(self,input_spike):
        ...
        d_spike1 = self.d_input[:, :, 0]
        d_spike2 = self.d_input[:, :, 1]
        d_spike3 = self.d_input[:, :, 2]
        d_spike4 = self.d_input[:, :, 3]
        alpha = torch.sigmoid(self.tau_m) #obtaining this.
        ...
        return self.mem,self.spike, d_spike1, d_spike2, d_spike3, d_spike4, beta, alpha
